...
korean_name = ["lee seungro", "song miyoun", "lee mingeun", "kim jaemin", "kim bora", "moon jaein", "lee myungbak", "kim seonho", "park jaeho", "lee domin", "jung eunjung", "shin sangeun", "cho hyunjae"]
english_name = ["disney walt", "jobs steve", "trump donald", "yang andrew", "downey robert", "rogers steve", "mandela nelson", "hernandez maria", "smith alice", "king luther", "jesus christ"]
check_name = []
